...
outputDir="/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/FinalReport2/mumu/training_estimation/"
#outputDirEos= "/eos/user/l/lia/FCCee/FinalReport2/mumu/training_estimation/"
eosType = "eosuser"
...
#userBatchConfig="/afs/cern.ch/work/l/lia/private/FCC/FCCWorkplace/analysis/ZH_XSec/FinalReport2/S240/userConfig.py"
#USER DEFINED CODE
import ROOT
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            .Define("zbuilder_result_Hll", "HiggsTools::resonanceBuilder_mass_recoil2(91.2, 125, 0.4, 240, false)(leps, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
            .Define("zll_Hll", "ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>{zbuilder_result_Hll[0]}") # the Z
            .Define("zll_Hll_m", "FCCAnalyses::ReconstructedParticle::get_mass(zll_Hll)[0]")
            .Define("zll_leps_Hll", "ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>{zbuilder_result_Hll[1],zbuilder_result_Hll[2]}") # the leptons
            .Define("zll_leps_dummy", "ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>{}") # the leptons
            .Define("leps_to_remove", "return (zll_Hll_m > (125-3) && zll_Hll_m < (125+3)) ? zll_leps_Hll : zll_leps_dummy")
            .Define("leps_good", "FCCAnalyses::ReconstructedParticle::remove(leps, leps_to_remove)") 
            .Filter("leps_no >= 2 && abs(Sum(leps_q)) < leps_q.size()") 
            .Define("zbuilder_result", "HiggsTools::resonanceBuilder_mass_recoil2(91.2, 125, 0.4, 240, false)(leps_good, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
            ...
            #.Define("cut4", "4")
            .Filter("zll_recoil_m < 150 && zll_recoil_m > 120")
            #.Define("cut5", "5")
        )
        return df2
