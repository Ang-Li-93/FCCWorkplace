import os
#repo = os.getenv('PWD')
repo = f"/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/FinalReport2/S{ecm}/{final_state}"
...
loc.EOS = f"/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/FinalReport2/S{ecm}/{final_state}"
...
mode_names = {f"{final_state}H": f"wzp6_ee_{final_state}H_ecm{ecm}",
              ...
              f"WW{final_state}": f"p8_ee_WW_{final_state}_ecm240{ecm}",
              "Zll": f"wzp6_ee_{final_state}_ecm{ecm}",
              "egamma": f"wzp6_egamma_eZ_Z{final_state}_ecm{ecm}",
              "gammae": f"wzp6_gammae_eZ_Z{final_state}_ecm{ecm}",
