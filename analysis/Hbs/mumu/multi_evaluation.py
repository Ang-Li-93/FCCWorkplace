...
def evaluate_bdt_model(df, bdt, vars_list):
    ...
    # Since class 2 = rare/off-diagonal Higgs decays, this is probably what you want.
...
def plot_bdt_score(df, label):
    ...
    scores = ["BDTscore_class0", "BDTscore_class1", "BDTscore_class2", "BDTscore_class3", "BDTscore_class4"]

    for BDTscore in scores:

        #This currently plots all truth cases for just the rare decays
        ...
        line = ['solid', 'dashed', 'solid', 'dashed', 'solid', 'dashed', 'solid', 'dashed', 'solid', 'dashed']
        color = ['red', 'red', 'blue', 'blue', 'green', 'green', 'purple', 'purple', 'yellow', 'yellow']
        cut = ['valid==False & label==0', 
            'valid==True & label==0',
            'valid==False & label==1', 
            'valid==True & label==1', 
            'valid==False & label==2', 
        ...
        plt.savefig(f"{loc.PLOTS}/{BDTscore}_prob.png")
