...
process_list=['kkmcp8_ee_mumu_ecm240','wzp6_ee_mumu_ecm240']
...
variables = {
    ...
    "z_MC_pt":{"name":"zed_leptonic_MC_pt","title":"MC p_{T}^{#mu^{+}#mu^{-}} [GeV]","bin":400,"xmin":0,"xmax":150},
...
import config.runDataFrameRenorm as rdf
myana=rdf.runDataFrameRenorm(baseDir,procDict,process_list,cut_list,variables)
