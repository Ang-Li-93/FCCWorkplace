...
basedir=os.path.join(os.getenv('FCCDICTSDIR', deffccdicts), '') + "yaml/FCCee/spring2021/IDEA_FullSilicon/"
...
#process_list=['p8_ee_ZH_ecm240','p8_ee_WW_mumu_ecm240','p8_ee_ZZ_ecm240']
...
process_list=['wzp6_ee_mumuH_ecm240','p8_ee_WW_mumu_ecm240','p8_ee_ZZ_ecm240','p8_ee_Zll_ecm240']
fraction=1.0
