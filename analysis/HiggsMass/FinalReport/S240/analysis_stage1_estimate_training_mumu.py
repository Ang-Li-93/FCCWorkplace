...
userBatchConfig="/afs/cern.ch/work/l/lia/private/FCC/NewWorkFlow/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/FinalReport2/userBatch.Config"
#USER DEFINED CODE
import ROOT
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            .Define("zbuilder_result_Hll", "HiggsTools::resonanceBuilder_mass_recoil(125, 91.2, 0.4, 240, false)(leps, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
            ...
            .Filter("leps_no >= 2 && abs(Sum(leps_q)) < leps_q.size()") 
            .Define("zbuilder_result", "HiggsTools::resonanceBuilder_mass_recoil(91.2, 125, 0.4, 240, false)(leps_good, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
