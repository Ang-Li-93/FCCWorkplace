...
outputDir="/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/ForAndrew/"
#outputDir="/atlasgpfs01/usatlas/data/ajones2/analysis/"
outputDirEos= "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/ForAndrew/"
#eosType = "eosuser"
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            .Define("zbuilder_result", "HiggsTools::resonanceBuilder_mass_recoil(91.2, %i, 0.4, 240, false)(leps, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)"%(mH))
            ...
            #.Filter("zll_m > 36 && zll_m < 146") 
            #.Filter("zll_m > 86 && zll_m < 96") 
            #.Define("cut3", "3")
            #.Filter("zll_p > 20 && zll_p < 70")
            #.Define("cut4", "4")
            #.Filter("zll_recoil_m < 140 && zll_recoil_m > 85")
            #.Define("cut5", "5")
        )
        return df2
